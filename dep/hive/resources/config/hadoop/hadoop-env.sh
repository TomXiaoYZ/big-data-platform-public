...
export HADOOP_NAMENODE_OPTS="-XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=70 -XX:+CMSParallelRemarkEnabled -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=19103 -javaagent:/opt/exporter/jmx/jmx_prometheus_javaagent-0.16.1.jar=9103:/opt/exporter/jmx/yaml/hdfs-namenode.yaml"
export HADOOP_DATANODE_HEAPSIZE=1699
export HDFS_ZKFC_OPTS="-Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=19109 -Duser.timezone=GMT+08 -javaagent:/opt/exporter/jmx/jmx_prometheus_javaagent-0.16.1.jar=9109:/opt/exporter/jmx/yaml/hdfs-zkfc.yaml"
export HADOOP_JOURNALNODE_OPTS="-Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=19105 -Duser.timezone=GMT+08 -javaagent:/opt/exporter/jmx/jmx_prometheus_javaagent-0.16.1.jar=9105:/opt/exporter/jmx/yaml/hdfs-journalnode.yaml"
export YARN_RESOURCEMANAGER_OPTS="-XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=70 -XX:+CMSParallelRemarkEnabled -Dlibrary.leveldbjni.path={{CONF_DIR}} -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=19101 -Duser.timezone=GMT+08 -javaagent:/opt/exporter/jmx/jmx_prometheus_javaagent-0.16.1.jar=9101:/opt/exporter/jmx/yaml/yarn-resourcemanager.yaml"
