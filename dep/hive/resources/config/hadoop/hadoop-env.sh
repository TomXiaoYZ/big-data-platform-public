...
export YARN_RESOURCEMANAGER_OPTS="-XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=70 -XX:+CMSParallelRemarkEnabled  -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=19101 -Duser.timezone=GMT+08 -javaagent:/opt/exporter/jmx/jmx_prometheus_javaagent-0.16.1.jar=9101:/opt/exporter/jmx/yaml/yarn-resourcemanager.yaml"
